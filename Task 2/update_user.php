...
<body>
    ...
    <br>
    <button style="width: 70px; height: 25px;" onclick="location.href='http://localhost/Corelia/Corelia-sweedy-internship/Ali Tarek Mohamed/profile.php'">← Back</button><br><br>
</body>
